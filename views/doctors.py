...
def render_doctors():
        ...
        <div style="display:flex; align-items:center; gap:0.8rem;">
            ...
            <div>
                ...
                <p style="color:#64748b; font-size:0.85rem; margin:0.15rem 0 0 0;">
                    Connect with cardiologists and specialists — request an appointment instantly</p>
            </div>
        </div>
    </div>
    ...
    for i, doc in enumerate(doctors):
        ...
        specialty_color = {
            "Cardiologist": "#8b5cf6", "Cardiac Surgeon": "#ef4444", "General Physician": "#06b6d4"
        ...
        <div style="background:rgba(30,41,59,0.5); border:1px solid rgba(148,163,184,0.08);
             ...
             onmouseover="this.style.borderColor='rgba(139,92,246,0.2)'"
            ...
            <div style="display:flex; gap:1.2rem; font-size:0.8rem; color:#94a3b8; margin-bottom:0.6rem;">
                <span>⭐ <b style="color:#f59e0b;">{doc['rating']}</b>/5.0</span>
                <span>🎓 {doc['experience']} yrs</span>
                <span>💰 {doc['fee']}</span>
            </div>
            <div style="font-size:0.78rem; color:#64748b;">📞 {doc['phone']}</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    <div style="background:rgba(6,182,212,0.05); border:1px solid rgba(6,182,212,0.1);
         border-radius:8px; padding:0.8rem 1.1rem; font-size:0.8rem; color:#67e8f9;">
