...
def render_updates():
    ...
    st.markdown("""<div style="background:rgba(30,41,59,0.5); border:1px solid rgba(148,163,184,0.08); border-radius:12px; padding:1.5rem 2rem; margin-bottom:1.5rem;"><h1 style="font-family:'Sora',sans-serif; font-size:1.6rem; font-weight:700; margin:0; color:#e2e8f0;">My Updates</h1><p style="color:#64748b; font-size:0.85rem; margin:0.15rem 0 0;">Doctor notes, appointment confirmations, and health updates from your care team</p></div>""", unsafe_allow_html=True)
    ...
    if not notes:
        ...
        for note in notes:
            ...
            st.markdown(f"""
            <div style="background:rgba(20,30,50,0.55); border:1px solid rgba(148,163,184,0.08);
                 border-radius:12px; padding:1.3rem 1.5rem; margin-bottom:0.8rem; border-left:3px solid #38bdf8;">
